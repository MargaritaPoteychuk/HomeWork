...
import page.GroupLetter;
import page.Login;
import page.Spam;

public class GroupLetterTest {
    private static GroupLetter groupLetter;
    ...
    public static void before() {
        ...
        groupLetter = new GroupLetter(driver);
    }

    @Test
    public void letterNotSpam() {
        login.login("mfedorova0604", "iloveLiverpool123");
        String actual = groupLetter.writeGroupLetter();
        String expected = "Письмо отправлено";
